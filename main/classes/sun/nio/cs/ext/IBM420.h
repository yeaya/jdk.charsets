#ifndef _sun_nio_cs_ext_IBM420_h_
#define _sun_nio_cs_ext_IBM420_h_
//$ class sun.nio.cs.ext.IBM420
...
class IBM420 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM420, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM420();
...
#endif // _sun_nio_cs_ext_IBM420_h_