#ifndef _sun_nio_cs_ext_IBM273_h_
#define _sun_nio_cs_ext_IBM273_h_
//$ class sun.nio.cs.ext.IBM273
...
class IBM273 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM273, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM273();
...
#endif // _sun_nio_cs_ext_IBM273_h_