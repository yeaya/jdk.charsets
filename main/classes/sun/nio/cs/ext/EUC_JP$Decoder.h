#ifndef _sun_nio_cs_ext_EUC_JP$Decoder_h_
#define _sun_nio_cs_ext_EUC_JP$Decoder_h_
//$ class sun.nio.cs.ext.EUC_JP$Decoder
...
class EUC_JP$Decoder : public ::java::nio::charset::CharsetDecoder, public ::sun::nio::cs::DelegatableDecoder {
	$class(EUC_JP$Decoder, 0, ::java::nio::charset::CharsetDecoder, ::sun::nio::cs::DelegatableDecoder)
public:
	EUC_JP$Decoder();
...
#endif // _sun_nio_cs_ext_EUC_JP$Decoder_h_