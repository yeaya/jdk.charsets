#ifndef _sun_nio_cs_ext_MacThai_h_
#define _sun_nio_cs_ext_MacThai_h_
//$ class sun.nio.cs.ext.MacThai
...
class MacThai : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(MacThai, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	MacThai();
...
#endif // _sun_nio_cs_ext_MacThai_h_