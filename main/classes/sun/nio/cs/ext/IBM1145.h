#ifndef _sun_nio_cs_ext_IBM1145_h_
#define _sun_nio_cs_ext_IBM1145_h_
//$ class sun.nio.cs.ext.IBM1145
...
class IBM1145 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1145, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1145();
...
#endif // _sun_nio_cs_ext_IBM1145_h_