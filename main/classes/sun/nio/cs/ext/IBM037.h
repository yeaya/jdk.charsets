#ifndef _sun_nio_cs_ext_IBM037_h_
#define _sun_nio_cs_ext_IBM037_h_
//$ class sun.nio.cs.ext.IBM037
...
class IBM037 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM037, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM037();
...
#endif // _sun_nio_cs_ext_IBM037_h_