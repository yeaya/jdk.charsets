#ifndef _sun_nio_cs_ext_Big5_h_
#define _sun_nio_cs_ext_Big5_h_
//$ class sun.nio.cs.ext.Big5
...
class Big5 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(Big5, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	Big5();
