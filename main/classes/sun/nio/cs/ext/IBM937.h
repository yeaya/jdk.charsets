#ifndef _sun_nio_cs_ext_IBM937_h_
#define _sun_nio_cs_ext_IBM937_h_
//$ class sun.nio.cs.ext.IBM937
...
class IBM937 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM937, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM937();
...
#endif // _sun_nio_cs_ext_IBM937_h_