...
using $IBM278 = ::sun::nio::cs::ext::IBM278;
...
$FieldInfo _IBM278$Holder_FieldInfo_[] = {
...
$MethodInfo _IBM278$Holder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(IBM278$Holder::*)()>(&IBM278$Holder::init$))},
	{}
};

$InnerClassInfo _IBM278$Holder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.IBM278$Holder", "sun.nio.cs.ext.IBM278", "Holder", $PRIVATE | $STATIC},
	{}
};

$ClassInfo _IBM278$Holder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.IBM278$Holder",
	"java.lang.Object",
	nullptr,
	_IBM278$Holder_FieldInfo_,
	_IBM278$Holder_MethodInfo_,
	nullptr,
	nullptr,
	_IBM278$Holder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$IBM278$Holder($Class* clazz) {
	return $of($alloc(IBM278$Holder));
}
...
void clinit$IBM278$Holder($Class* class$) {
	...
	$assignStatic(IBM278$Holder::b2c, $nc(IBM278$Holder::b2cTable)->toCharArray());
	...
	$assignStatic(IBM278$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, $nc(IBM278$Holder::b2cTable)->toCharArray());
...
$Class* IBM278$Holder::load$($String* name, bool initialize) {
	$loadClass(IBM278$Holder, name, initialize, &_IBM278$Holder_ClassInfo_, clinit$IBM278$Holder, allocate$IBM278$Holder);
	return class$;
}
