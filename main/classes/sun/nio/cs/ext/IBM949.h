#ifndef _sun_nio_cs_ext_IBM949_h_
#define _sun_nio_cs_ext_IBM949_h_
//$ class sun.nio.cs.ext.IBM949
...
class IBM949 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM949, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM949();
...
#endif // _sun_nio_cs_ext_IBM949_h_