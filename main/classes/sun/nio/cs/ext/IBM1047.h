#ifndef _sun_nio_cs_ext_IBM1047_h_
#define _sun_nio_cs_ext_IBM1047_h_
//$ class sun.nio.cs.ext.IBM1047
...
class IBM1047 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1047, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1047();
...
#endif // _sun_nio_cs_ext_IBM1047_h_