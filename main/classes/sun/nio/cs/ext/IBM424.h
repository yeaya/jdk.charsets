#ifndef _sun_nio_cs_ext_IBM424_h_
#define _sun_nio_cs_ext_IBM424_h_
//$ class sun.nio.cs.ext.IBM424
...
class IBM424 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM424, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM424();
...
#endif // _sun_nio_cs_ext_IBM424_h_