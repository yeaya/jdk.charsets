#ifndef _sun_nio_cs_ext_IBM1129_h_
#define _sun_nio_cs_ext_IBM1129_h_
//$ class sun.nio.cs.ext.IBM1129
...
class IBM1129 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1129, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1129();
...
#endif // _sun_nio_cs_ext_IBM1129_h_