#ifndef _sun_nio_cs_ext_IBM1140_h_
#define _sun_nio_cs_ext_IBM1140_h_
//$ class sun.nio.cs.ext.IBM1140
...
class IBM1140 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1140, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1140();
...
#endif // _sun_nio_cs_ext_IBM1140_h_