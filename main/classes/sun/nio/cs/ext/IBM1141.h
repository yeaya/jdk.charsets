#ifndef _sun_nio_cs_ext_IBM1141_h_
#define _sun_nio_cs_ext_IBM1141_h_
//$ class sun.nio.cs.ext.IBM1141
...
class IBM1141 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1141, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1141();
...
#endif // _sun_nio_cs_ext_IBM1141_h_