#ifndef _sun_nio_cs_ext_IBM970_h_
#define _sun_nio_cs_ext_IBM970_h_
//$ class sun.nio.cs.ext.IBM970
...
class IBM970 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM970, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM970();
...
#endif // _sun_nio_cs_ext_IBM970_h_