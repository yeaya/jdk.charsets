#ifndef _sun_nio_cs_ext_IBM500_h_
#define _sun_nio_cs_ext_IBM500_h_
//$ class sun.nio.cs.ext.IBM500
...
class IBM500 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM500, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM500();
...
#endif // _sun_nio_cs_ext_IBM500_h_