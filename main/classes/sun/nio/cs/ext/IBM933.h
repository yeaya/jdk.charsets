#ifndef _sun_nio_cs_ext_IBM933_h_
#define _sun_nio_cs_ext_IBM933_h_
//$ class sun.nio.cs.ext.IBM933
...
class IBM933 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM933, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM933();
...
#endif // _sun_nio_cs_ext_IBM933_h_