#ifndef _sun_nio_cs_ext_IBM1006_h_
#define _sun_nio_cs_ext_IBM1006_h_
//$ class sun.nio.cs.ext.IBM1006
...
class IBM1006 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1006, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1006();
...
#endif // _sun_nio_cs_ext_IBM1006_h_