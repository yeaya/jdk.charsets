#ifndef _sun_nio_cs_ext_ISO2022_KR_h_
#define _sun_nio_cs_ext_ISO2022_KR_h_
...
class ISO2022_KR : public ::sun::nio::cs::ext::ISO2022, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(ISO2022_KR, $NO_CLASS_INIT, ::sun::nio::cs::ext::ISO2022, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	ISO2022_KR();
...
#endif // _sun_nio_cs_ext_ISO2022_KR_h_