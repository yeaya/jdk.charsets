#ifndef _sun_nio_cs_ext_IBM1098_h_
#define _sun_nio_cs_ext_IBM1098_h_
//$ class sun.nio.cs.ext.IBM1098
...
class IBM1098 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1098, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1098();
...
#endif // _sun_nio_cs_ext_IBM1098_h_