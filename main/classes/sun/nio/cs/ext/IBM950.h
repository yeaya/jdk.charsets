#ifndef _sun_nio_cs_ext_IBM950_h_
#define _sun_nio_cs_ext_IBM950_h_
//$ class sun.nio.cs.ext.IBM950
...
class IBM950 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM950, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM950();
...
#endif // _sun_nio_cs_ext_IBM950_h_