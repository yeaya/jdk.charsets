...
using $IBM1123 = ::sun::nio::cs::ext::IBM1123;
...
$FieldInfo _IBM1123$Holder_FieldInfo_[] = {
...
$MethodInfo _IBM1123$Holder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(IBM1123$Holder::*)()>(&IBM1123$Holder::init$))},
	{}
};

$InnerClassInfo _IBM1123$Holder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.IBM1123$Holder", "sun.nio.cs.ext.IBM1123", "Holder", $PRIVATE | $STATIC},
	{}
};

$ClassInfo _IBM1123$Holder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.IBM1123$Holder",
	"java.lang.Object",
	nullptr,
	_IBM1123$Holder_FieldInfo_,
	_IBM1123$Holder_MethodInfo_,
	nullptr,
	nullptr,
	_IBM1123$Holder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$IBM1123$Holder($Class* clazz) {
	return $of($alloc(IBM1123$Holder));
}
...
void clinit$IBM1123$Holder($Class* class$) {
	...
	$assignStatic(IBM1123$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, $nc(IBM1123$Holder::b2cTable)->toCharArray());
...
$Class* IBM1123$Holder::load$($String* name, bool initialize) {
	$loadClass(IBM1123$Holder, name, initialize, &_IBM1123$Holder_ClassInfo_, clinit$IBM1123$Holder, allocate$IBM1123$Holder);
	return class$;
}
