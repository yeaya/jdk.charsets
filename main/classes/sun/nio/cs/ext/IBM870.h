#ifndef _sun_nio_cs_ext_IBM870_h_
#define _sun_nio_cs_ext_IBM870_h_
//$ class sun.nio.cs.ext.IBM870
...
class IBM870 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM870, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM870();
...
#endif // _sun_nio_cs_ext_IBM870_h_