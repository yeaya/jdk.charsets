...
$FieldInfo _IBM970$DecodeHolder_FieldInfo_[] = {
	{"b2cSBStr", "Ljava/lang/String;", nullptr, $STATIC | $FINAL, $staticField(IBM970$DecodeHolder, b2cSBStr)},
	{"b2cStr", "[Ljava/lang/String;", nullptr, $STATIC | $FINAL, $staticField(IBM970$DecodeHolder, b2cStr)},
	{"b2c", "[[C", nullptr, $STATIC | $FINAL, $staticField(IBM970$DecodeHolder, b2c)},
	{"b2cSB", "[C", nullptr, $STATIC | $FINAL, $staticField(IBM970$DecodeHolder, b2cSB)},
	{}
};

$MethodInfo _IBM970$DecodeHolder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IBM970$DecodeHolder::*)()>(&IBM970$DecodeHolder::init$))},
	{}
};

$InnerClassInfo _IBM970$DecodeHolder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.IBM970$DecodeHolder", "sun.nio.cs.ext.IBM970", "DecodeHolder", $STATIC},
	{}
};

$ClassInfo _IBM970$DecodeHolder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.IBM970$DecodeHolder",
	"java.lang.Object",
	nullptr,
	_IBM970$DecodeHolder_FieldInfo_,
	_IBM970$DecodeHolder_MethodInfo_,
	nullptr,
	nullptr,
	_IBM970$DecodeHolder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
void clinit$IBM970$DecodeHolder($Class* class$) {
	...
	$assignStatic(IBM970$DecodeHolder::b2c, $new($charArray2, $nc(IBM970$DecodeHolder::b2cStr)->length));
	{
		for (int32_t i = 0; i < $nc(IBM970$DecodeHolder::b2cStr)->length; ++i) {
			if ($nc(IBM970$DecodeHolder::b2cStr)->get(i) == nullptr) {
				$init($DoubleByte);
				$nc(IBM970$DecodeHolder::b2c)->set(i, $DoubleByte::B2C_UNMAPPABLE);
			} else {
				$nc(IBM970$DecodeHolder::b2c)->set(i, $($nc($nc(IBM970$DecodeHolder::b2cStr)->get(i))->toCharArray()));
			}
		}
		$assignStatic(IBM970$DecodeHolder::b2cSB, $nc(IBM970$DecodeHolder::b2cSBStr)->toCharArray());
	}
}

IBM970$DecodeHolder::IBM970$DecodeHolder() {
}

$Class* IBM970$DecodeHolder::load$($String* name, bool initialize) {
	$loadClass(IBM970$DecodeHolder, name, initialize, &_IBM970$DecodeHolder_ClassInfo_, clinit$IBM970$DecodeHolder, allocate$IBM970$DecodeHolder);
	return class$;
}

$Class* IBM970$DecodeHolder::class$ = nullptr;
