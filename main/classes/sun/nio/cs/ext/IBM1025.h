#ifndef _sun_nio_cs_ext_IBM1025_h_
#define _sun_nio_cs_ext_IBM1025_h_
//$ class sun.nio.cs.ext.IBM1025
...
class IBM1025 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1025, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1025();
...
#endif // _sun_nio_cs_ext_IBM1025_h_