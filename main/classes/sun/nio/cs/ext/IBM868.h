#ifndef _sun_nio_cs_ext_IBM868_h_
#define _sun_nio_cs_ext_IBM868_h_
//$ class sun.nio.cs.ext.IBM868
...
class IBM868 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM868, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM868();
...
#endif // _sun_nio_cs_ext_IBM868_h_