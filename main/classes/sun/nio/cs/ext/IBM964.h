#ifndef _sun_nio_cs_ext_IBM964_h_
#define _sun_nio_cs_ext_IBM964_h_
//$ class sun.nio.cs.ext.IBM964
...
class IBM964 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM964, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM964();
...
#endif // _sun_nio_cs_ext_IBM964_h_