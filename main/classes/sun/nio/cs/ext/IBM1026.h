#ifndef _sun_nio_cs_ext_IBM1026_h_
#define _sun_nio_cs_ext_IBM1026_h_
//$ class sun.nio.cs.ext.IBM1026
...
class IBM1026 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1026, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1026();
...
#endif // _sun_nio_cs_ext_IBM1026_h_