#ifndef _sun_nio_cs_ext_IBM285_h_
#define _sun_nio_cs_ext_IBM285_h_
//$ class sun.nio.cs.ext.IBM285
...
class IBM285 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM285, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM285();
...
#endif // _sun_nio_cs_ext_IBM285_h_