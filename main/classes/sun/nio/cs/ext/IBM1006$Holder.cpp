...
using $IBM1006 = ::sun::nio::cs::ext::IBM1006;
...
$MethodInfo _IBM1006$Holder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(IBM1006$Holder::*)()>(&IBM1006$Holder::init$))},
	{}
};
...
$chars* IBM1006$Holder::c2bIndex = nullptr;
...
void clinit$IBM1006$Holder($Class* class$) {
	...
	{
		$var($chars, b2cMap, IBM1006$Holder::b2c);
		$var($chars, c2bNR, nullptr);
		$SingleByte::initC2B(b2cMap, c2bNR, IBM1006$Holder::c2b, IBM1006$Holder::c2bIndex);
	}
}

IBM1006$Holder::IBM1006$Holder() {
}
...
$Class* IBM1006$Holder::class$ = nullptr;
