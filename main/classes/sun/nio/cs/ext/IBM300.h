#ifndef _sun_nio_cs_ext_IBM300_h_
#define _sun_nio_cs_ext_IBM300_h_
//$ class sun.nio.cs.ext.IBM300
...
class IBM300 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM300, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM300();
...
#endif // _sun_nio_cs_ext_IBM300_h_