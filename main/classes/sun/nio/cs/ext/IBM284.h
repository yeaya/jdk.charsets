#ifndef _sun_nio_cs_ext_IBM284_h_
#define _sun_nio_cs_ext_IBM284_h_
//$ class sun.nio.cs.ext.IBM284
...
class IBM284 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM284, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM284();
...
#endif // _sun_nio_cs_ext_IBM284_h_