#ifndef _sun_nio_cs_ext_TIS_620_h_
#define _sun_nio_cs_ext_TIS_620_h_
//$ class sun.nio.cs.ext.TIS_620
...
class TIS_620 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(TIS_620, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	TIS_620();
...
#endif // _sun_nio_cs_ext_TIS_620_h_