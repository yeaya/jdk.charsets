#ifndef _sun_nio_cs_ext_IBM280_h_
#define _sun_nio_cs_ext_IBM280_h_
//$ class sun.nio.cs.ext.IBM280
...
class IBM280 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM280, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM280();
...
#endif // _sun_nio_cs_ext_IBM280_h_