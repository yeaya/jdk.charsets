...
using $IBM871 = ::sun::nio::cs::ext::IBM871;
...
$FieldInfo _IBM871$Holder_FieldInfo_[] = {
...
$MethodInfo _IBM871$Holder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(IBM871$Holder::*)()>(&IBM871$Holder::init$))},
	{}
};

$InnerClassInfo _IBM871$Holder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.IBM871$Holder", "sun.nio.cs.ext.IBM871", "Holder", $PRIVATE | $STATIC},
	{}
};

$ClassInfo _IBM871$Holder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.IBM871$Holder",
	"java.lang.Object",
	nullptr,
	_IBM871$Holder_FieldInfo_,
	_IBM871$Holder_MethodInfo_,
	nullptr,
	nullptr,
	_IBM871$Holder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$IBM871$Holder($Class* clazz) {
	return $of($alloc(IBM871$Holder));
}
...
void clinit$IBM871$Holder($Class* class$) {
	...
	$assignStatic(IBM871$Holder::b2c, $nc(IBM871$Holder::b2cTable)->toCharArray());
	...
	$assignStatic(IBM871$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, $nc(IBM871$Holder::b2cTable)->toCharArray());
...
$Class* IBM871$Holder::load$($String* name, bool initialize) {
	$loadClass(IBM871$Holder, name, initialize, &_IBM871$Holder_ClassInfo_, clinit$IBM871$Holder, allocate$IBM871$Holder);
	return class$;
}
