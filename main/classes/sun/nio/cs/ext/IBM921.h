#ifndef _sun_nio_cs_ext_IBM921_h_
#define _sun_nio_cs_ext_IBM921_h_
//$ class sun.nio.cs.ext.IBM921
...
class IBM921 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM921, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM921();
...
#endif // _sun_nio_cs_ext_IBM921_h_