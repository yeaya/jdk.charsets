#ifndef _sun_nio_cs_ext_IBM863_h_
#define _sun_nio_cs_ext_IBM863_h_
//$ class sun.nio.cs.ext.IBM863
...
class IBM863 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM863, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM863();
...
#endif // _sun_nio_cs_ext_IBM863_h_