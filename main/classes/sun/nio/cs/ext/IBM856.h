#ifndef _sun_nio_cs_ext_IBM856_h_
#define _sun_nio_cs_ext_IBM856_h_
//$ class sun.nio.cs.ext.IBM856
...
class IBM856 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM856, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM856();
...
#endif // _sun_nio_cs_ext_IBM856_h_