...
$FieldInfo _EUC_KR$DecodeHolder_FieldInfo_[] = {
	{"b2cSBStr", "Ljava/lang/String;", nullptr, $STATIC | $FINAL, $staticField(EUC_KR$DecodeHolder, b2cSBStr)},
	{"b2cStr", "[Ljava/lang/String;", nullptr, $STATIC | $FINAL, $staticField(EUC_KR$DecodeHolder, b2cStr)},
	{"b2c", "[[C", nullptr, $STATIC | $FINAL, $staticField(EUC_KR$DecodeHolder, b2c)},
	{"b2cSB", "[C", nullptr, $STATIC | $FINAL, $staticField(EUC_KR$DecodeHolder, b2cSB)},
	{}
};

$MethodInfo _EUC_KR$DecodeHolder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(EUC_KR$DecodeHolder::*)()>(&EUC_KR$DecodeHolder::init$))},
	{}
};

$InnerClassInfo _EUC_KR$DecodeHolder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.EUC_KR$DecodeHolder", "sun.nio.cs.ext.EUC_KR", "DecodeHolder", $STATIC},
	{}
};

$ClassInfo _EUC_KR$DecodeHolder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.EUC_KR$DecodeHolder",
	"java.lang.Object",
	nullptr,
	_EUC_KR$DecodeHolder_FieldInfo_,
	_EUC_KR$DecodeHolder_MethodInfo_,
	nullptr,
	nullptr,
	_EUC_KR$DecodeHolder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
void clinit$EUC_KR$DecodeHolder($Class* class$) {
	...
	$assignStatic(EUC_KR$DecodeHolder::b2c, $new($charArray2, $nc(EUC_KR$DecodeHolder::b2cStr)->length));
	{
		for (int32_t i = 0; i < $nc(EUC_KR$DecodeHolder::b2cStr)->length; ++i) {
			if ($nc(EUC_KR$DecodeHolder::b2cStr)->get(i) == nullptr) {
				$init($DoubleByte);
				$nc(EUC_KR$DecodeHolder::b2c)->set(i, $DoubleByte::B2C_UNMAPPABLE);
			} else {
				$nc(EUC_KR$DecodeHolder::b2c)->set(i, $($nc($nc(EUC_KR$DecodeHolder::b2cStr)->get(i))->toCharArray()));
			}
		}
		$assignStatic(EUC_KR$DecodeHolder::b2cSB, $nc(EUC_KR$DecodeHolder::b2cSBStr)->toCharArray());
	}
}

EUC_KR$DecodeHolder::EUC_KR$DecodeHolder() {
}

$Class* EUC_KR$DecodeHolder::load$($String* name, bool initialize) {
	$loadClass(EUC_KR$DecodeHolder, name, initialize, &_EUC_KR$DecodeHolder_ClassInfo_, clinit$EUC_KR$DecodeHolder, allocate$EUC_KR$DecodeHolder);
	return class$;
}

$Class* EUC_KR$DecodeHolder::class$ = nullptr;
