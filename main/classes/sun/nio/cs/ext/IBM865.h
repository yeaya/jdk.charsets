#ifndef _sun_nio_cs_ext_IBM865_h_
#define _sun_nio_cs_ext_IBM865_h_
//$ class sun.nio.cs.ext.IBM865
...
class IBM865 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM865, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM865();
...
#endif // _sun_nio_cs_ext_IBM865_h_