#ifndef _sun_nio_cs_ext_IBM861_h_
#define _sun_nio_cs_ext_IBM861_h_
//$ class sun.nio.cs.ext.IBM861
...
class IBM861 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM861, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM861();
...
#endif // _sun_nio_cs_ext_IBM861_h_