#ifndef _sun_nio_cs_ext_IBM939_h_
#define _sun_nio_cs_ext_IBM939_h_
//$ class sun.nio.cs.ext.IBM939
...
class IBM939 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM939, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM939();
...
#endif // _sun_nio_cs_ext_IBM939_h_