...
using $IBM861 = ::sun::nio::cs::ext::IBM861;
...
$FieldInfo _IBM861$Holder_FieldInfo_[] = {
...
$MethodInfo _IBM861$Holder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(IBM861$Holder::*)()>(&IBM861$Holder::init$))},
	{}
};

$InnerClassInfo _IBM861$Holder_InnerClassesInfo_[] = {
	{"sun.nio.cs.ext.IBM861$Holder", "sun.nio.cs.ext.IBM861", "Holder", $PRIVATE | $STATIC},
	{}
};

$ClassInfo _IBM861$Holder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.ext.IBM861$Holder",
	"java.lang.Object",
	nullptr,
	_IBM861$Holder_FieldInfo_,
	_IBM861$Holder_MethodInfo_,
	nullptr,
	nullptr,
	_IBM861$Holder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$IBM861$Holder($Class* clazz) {
	return $of($alloc(IBM861$Holder));
}
...
$Class* IBM861$Holder::load$($String* name, bool initialize) {
	$loadClass(IBM861$Holder, name, initialize, &_IBM861$Holder_ClassInfo_, clinit$IBM861$Holder, allocate$IBM861$Holder);
	return class$;
}
