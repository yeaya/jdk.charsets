#ifndef _sun_nio_cs_ext_IBM1123_h_
#define _sun_nio_cs_ext_IBM1123_h_
//$ class sun.nio.cs.ext.IBM1123
...
class IBM1123 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM1123, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM1123();
...
#endif // _sun_nio_cs_ext_IBM1123_h_