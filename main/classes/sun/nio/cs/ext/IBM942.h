#ifndef _sun_nio_cs_ext_IBM942_h_
#define _sun_nio_cs_ext_IBM942_h_
//$ class sun.nio.cs.ext.IBM942
...
class IBM942 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM942, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM942();
...
#endif // _sun_nio_cs_ext_IBM942_h_