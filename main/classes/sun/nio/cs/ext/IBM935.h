#ifndef _sun_nio_cs_ext_IBM935_h_
#define _sun_nio_cs_ext_IBM935_h_
//$ class sun.nio.cs.ext.IBM935
...
class IBM935 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM935, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM935();
...
#endif // _sun_nio_cs_ext_IBM935_h_